...
//                    monday.text = "${mondaypersen}"
//                    tuesday.text = "${tuesdaypersen}"
//                    wednesday.text = "${wednesdaypersen}"
//                    thursday.text = "${thursdaypersen}"
//                    friday.text = "${fridaypersen}"
//                    saturday.text = "${saturdaypersen}"
//                    sunday.text = "${sundaypersen}"
